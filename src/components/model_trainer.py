...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            ################## added hyperparameter tunning for better performance ###########
            params={
                "Decision Tree": {
            ...
            if best_model_score<0.6:
                raise CustomException("No best model for the given dataset")
            logging.info(f"Best found model on training an testing is {best_model}")
            save_object(
